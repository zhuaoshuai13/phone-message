    ...
    function (a, b, c) {
      ...
      (f.version = '1.19.0'),
        ...
        (f.from = function (a, b, c) {
          return (
            (c.runBackwards = !0), (c.immediateRender = 0 != c.immediateRender), new f(a, b, c)
          );
        }),
        ...
        (f.staggerTo = f.allTo =
          function (a, b, g, h, k, m, n) {
            ...
            for (
              ...
              for (r in g) p[r] = g[r];
              if (
                (v && (e(p, a, q), null != p.duration && ((b = p.duration), delete p.duration)), w)
              ) {
                w = p.startAt = {};
      ...
      function (a, b, c) {
        ...
        return (
          ...
          (q.add = function (e, f, g, h) {
            var j, k, l, m, n, o;
            if (
              ('number' != typeof f && (f = this._parseTimeOrLabel(f, 0, !0, e)), !(e instanceof a))
            ) {
          ...
          (k.render = function (a, b, c) {
            ...
            if (a >= o - 1e-7)
              ...
              if (
                ...
                (this._time = 0),
                (0 !== q ||
                  (0 === p && u !== e && (u > 0 || (0 > a && u >= 0)) && !this._locked)) &&
                ...
                if (
                  ((this._rawPrevTime = p || !b || a || this._rawPrevTime === a ? a : e),
                  0 === a && f)
                )
                  for (d = this._first; d && 0 === d._startTime; )
                    d._duration || (f = !1), (d = d._next);
            ...
            if (
              (this._initted || (this._initted = !0),
              this._active ||
                (!this._paused && this._totalTime !== r && a > 0 && (this._active = !0)),
              0 === r &&
                this.vars.onStart &&
      ...
      function (a, b) {
        ...
        var k,
          ...
          Y = function (a, b) {
            ...
            return d >= 0
              ? ((X = 3 === d ? 'ms' : c[d]), (W = '-' + X.toLowerCase() + '-'), X + a)
              : null;
          },
          ...
          _ = (R.convertToPixels = function (a, c, d, e, f) {
            ...
            if ((n && (d = -d), o && (d *= 100), '%' === e && -1 !== c.indexOf('border')))
              ...
              if (
                ((m.cssText =
                  'border:0 solid red;position:' + $(a, 'position') + ';line-height:0;'),
        ...
        var pa = function (a, b, c, d) {
            ...
            return k
              ? (e = b
                  ? function (a) {
                      ...
                      return (
                        h + m.join(j) + j + b + i + (-1 !== a.indexOf('inset') ? ' inset' : '')
                      );
                    }
                  : function (a) {
                      var b, f, m;
          ...
          ra =
            ((R._setPluginRatio = function (a) {
              ...
              if (
                (g.autoRotate &&
                  (g.autoRotate.rotation = g.mod ? g.mod(h.rotation, this.t) : h.rotation),
                1 === a || 0 === a)
              )
                ...
                ? (g.l++,
                  ...
                  h > 0
                    ? ((g.data['xn' + h] = b + c),
                      ...
                      (g['xn' + h] = b),
                      g.plugin ||
                        ((g.xfirst = new sa(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)),
                        (g.xfirst.xs0 = 0)),
                      g)
        ...
        var za,
          ...
          Oa = function (a, b) {
            ...
            for (e = (d || '').match(s) || [], va = e.length; --va > -1; )
              (f = Number(e[va])),
                (e[va] = (g = f - (f |= 0)) ? ((g * j + (0 > g ? -0.5 : 0.5)) | 0) / j + f : f);
          ...
          Pa = (R.getTransform = function (a, c, d, e) {
            ...
            if (
              ...
              m.svg &&
                (Ka(a, $(a, Da, c, !1, '50% 50%') + '', m, a.getAttribute('data-svg-origin')),
          ...
          xa('backgroundPosition', {
            ...
            parser: function (a, b, c, d, f, g) {
              ...
              if (
                ...
                for (
                  h = q.split(' '), i = r.split(' '), Q.setAttribute('src', m), j = 2;
                  --j > -1;
          ...
          if (
            ...
            if ('all' === this.e) (g.cssText = ''), (e = !0);
              ...
              for (b = this.e.split(' ').join('').split(','), d = b.length; --d > -1; )
                (c = b[d]),
                  i[c] &&
                    (i[c].parse === h ? (e = !0) : (c = 'transformOrigin' === c ? Da : i[c].p)),
                  Ta(g, c);
            e &&
              (Ta(g, Ba),
                  ...
                  if (
                    ...
                    if (1 === e.type)
                      if (((d = e.l), 2 === d)) e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2;
                        ...
                        e.t[e.p] =
                          e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3 + e.xn3 + e.xs4;
                      else if (5 === d)
                        e.t[e.p] =
                          e.xs0 +
                          b +
    ...
    if (!d.TweenLite) {
            ...
            if (0 === t && g) {
              if (
                ...
                if (
                  ...
                  define(
                    (a.GreenSockAMDPath ? a.GreenSockAMDPath + '/' : '') + e.split('.').pop(),
                    [],
                    function () {
                      return o;
                    },
      ...
      var t = [0, 0, 1, 1],
        ...
        w = (u.register = function (a, b, c, d) {
          for (
            ...
            for (
              f = i[j], e = d ? s('easing.' + f, null, !0) : k.easing[f] || {}, g = l.length;
              --g > -1;
      ...
      (g = x.prototype),
        (g.addEventListener = function (a, b, c, d, e) {
          ...
          var f,
            ...
            k = 0;
          for (
            this !== h || i || h.wake(), null == j && (this._listeners[a] = j = []), g = j.length;
            --g > -1;
        ...
        (g.dispatchEvent = function (a) {
          ...
          if (e)
            for (b = e.length, b > 1 && (e = e.slice(0)), c = this._eventTarget; --b > -1; )
              (d = e[b]),
                d && (d.up ? d.c.call(d.s || c, { type: a, target: c }) : d.c.call(d.s || c));
        });
      ...
      s('Ticker', function (a, b) {
        ...
        x.call(j),
          ...
          (j.sleep = function () {
            null != e &&
              (m && z ? z(e) : clearTimeout(e), (d = n), (e = null), j === h && (i = !1));
          }),
          (j.wake = function (a) {
      ...
      D(),
        ...
        (g.eventCallback = function (a, b, c, d) {
          if ('on' === (a || '').substr(0, 2)) {
            ...
            null == b
              ...
              : ((e[a] = b),
                (e[a + 'Params'] =
                  o(c) && -1 !== c.join('').indexOf('{self}') ? this._swapSelfInParams(c) : c),
                (e[a + 'Scope'] = d)),
        ...
        (g.endTime = function (a) {
          return (
            this._startTime + (0 != a ? this.totalDuration() : this.duration()) / this._timeScale
          );
        }),
      ...
      var F = s(
          ...
          function (b, c, d) {
            ...
            if (
              ...
              for (
                this._targets = g = m(b), this._propLookup = [], this._siblings = [], e = 0;
                e < g.length;
                e++
              )
                (f = g[e]),
      ...
      (g._init = function () {
        ...
        (g.render = function (a, b, c) {
          ...
          if (this._time !== h || c) {
            ...
            for (
              this._lazy !== !1 && (this._lazy = !1),
                this._active ||
                  (!this._paused && this._time !== h && a >= 0 && (this._active = !0)),
                0 === h &&
                  (this._startAt &&
                    (a >= 0 ? this._startAt.render(a, b, c) : e || (e = '_dummyGS')),
                  this.vars.onStart &&
                    (0 !== this._time || 0 === i) &&
                    (b || this._callback('onStart'))),
                f = this._firstPT;
        ...
        (g._kill = function (a, b, c) {
          ...
          var d,
            ...
            l,
            m =
              c && this._time && c._startTime === this._startTime && this._timeline === c._timeline;
        ...
        (g._mod = g._roundProps =
          function (a) {
            for (var b, c = this._firstPT; c; )
              (b =
                a[this._propName] || (null != c.n && a[c.n.split(this._propName + '_').join('')])),
